#!/usr/bin/env python3
"""
Sounding Rocket Content Generator
Generates detailed engineering articles for sounding rocket topics using Anthropic's API
"""
...
class RocketContentGenerator:
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.output_dir = Path("sounding_rocket_articles")
    ...
    def get_topics(self) -> List[str]:
        """Return the list of sounding rocket topics"""
        return [
...
I am building a similar site for various subject areas related to practical, hands-on engineering, and starting with Sounding Rockets at the top level. Here are the list of topics for the site:
...
"""
    ...
    def generate_index(self, topics: Optional[List[str]] = None):
        ...
        index_content = "# Sounding Rockets\n\n"
        index_content += "A comprehensive guide to practical sounding rocket engineering.\n\n"
...
def main():
    ...
    # Example usage
    generator = RocketContentGenerator()
